package com.chuck.common.app.file;

import com.chuck.base.domain.exception.BaseException;
import com.chuck.common.app.file.value.StorageProperties;
...
public class SimpleStorageServiceImpl implements StorageService {
  ...
  public String storeElseAndRename(MultipartFile file, Path dir, String newName) {
    try {
      ...
      throw new BaseException(
          "Failed to store file " + newName + ",cause: " + e.getMessage(),
