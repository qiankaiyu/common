...
import com.chuck.common.utils.redis.RedisUtil;
import com.chuck.common.utils.web.CookieUtil;
...
public class JwtUtil {
  ...
  public static void invalidateRelatedTokens(HttpServletRequest httpServletRequest) {
    RedisUtil.INSTANCE.srem(
        REDIS_SET_ACTIVE_SUBJECTS, (String) httpServletRequest.getAttribute("username"));
  }
}
